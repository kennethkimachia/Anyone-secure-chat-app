...
exports.AnonControlClient = void 0;
const net = __importStar(require("net"));
class AnonControlClient {
    ...
    routerStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.sendCommand('GETINFO ns/all');
            ...
            for (const line of lines) {
                ...
                if (trimmedLine.startsWith('r ')) {
                    ...
                    currentRouter = {};
                    const [, nickname, fingerprint, digest, date, time, ip, orPort, dirPort] = trimmedLine.split(' ');
                    currentRouter = {
                        nickname,
                        fingerprint,
                        digest,
...
exports.AnonControlClient = AnonControlClient;
